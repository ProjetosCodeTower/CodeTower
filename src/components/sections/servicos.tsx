...
export const Servicos = () => {
    return (
        <div className="container grid grid-cols-1 lg:grid-cols-4 items-center justify-center text-center  gap-4 divide-y rounded-lg px-4 py-8 lg:divide-none [box-shadow:0_0_100px_#0000000d,0_1px_3px_#0000000d]">
            <span data-aos="fade-up" className="h-full flex flex-col items-center justify-start p-4 gap-2">
            ...
            <span data-aos="fade-up" className="h-full flex flex-col items-center justify-start gap-2 p-4 ">
            ...
            <span data-aos="fade-up" className="h-full flex flex-col items-center justify-start p-4 gap-2">
                ...
                <p>Oferecemos um serviço completo de hospedagem e manutenção para o seu site ou sistema web, garantindo que sua presença online seja sempre confiável e eficiente.</p>
            </span>
        </div>
    )
}
