        ...
        <div className="container z-10">
            ...
            <div className="projects-grid grid grid-cols-1 gap-4 rounded-lg py-4 md:grid-cols-12">
                <div className="group relative flex h-full flex-1 flex-col overflow-hidden rounded-lg aos-init aos-animate" data-aos="fade-left">
                    <Image className="h-72 w-full object-cover transition-all duration-300 ease-in-out group-hover:scale-105" src="https://images.unsplash.com/photo-1494500764479-0c8f2919a3d8?ixlib=rb-4.0.3&amp;q=85&amp;fm=webp&amp;crop=entropy&amp;cs=srgb&amp;w=640" alt="Projeto 1 - Code Stacker" title="Projeto 1 - Code Stacker" width="640" height="427" loading="lazy" />
                ...
                <div className="group relative flex h-full flex-1 flex-col overflow-hidden rounded-lg aos-init aos-animate" data-aos="fade-right">
                    <Image className="h-72 w-full object-cover transition-all duration-300 ease-in-out group-hover:scale-105" src="https://images.unsplash.com/photo-1511884642898-4c92249e20b6?ixlib=rb-4.0.3&amp;q=85&amp;fm=webp&amp;crop=entropy&amp;cs=srgb&amp;w=640" alt="Projeto 4 - Code Stacker" title="Projeto 4 - Code Stacker" width="640" height="427" loading="lazy" /><div className="absolute -bottom-full left-0 w-full bg-white/60 px-8 py-4 transition-all duration-300 ease-in-out group-hover:bottom-0">
