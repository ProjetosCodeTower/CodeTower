...
export const Sobre = () => {
    return (
        <div className="container flex">
            ...
            <img className="hidden h-72 w-full rounded-lg object-cover lg:flex aos-init aos-animate" src="https://images.unsplash.com/photo-1543269865-cbf427effbad?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=750&amp;q=80&amp;fm=webp" alt="Imagem de capa do site Code Stacker" data-aos="fade-up" title="Grupo Code Stacker" width="750" height="500" />
        </div>
    )
}
