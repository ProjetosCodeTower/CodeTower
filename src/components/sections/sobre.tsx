...
export const Sobre = () => {
    return (
        <div data-aos="fade-right" className="container flex max-md:flex-col max-md:gap-2">
            ...
            <div className="w-full max-md:container">
                <Image className="h-72 w-full rounded-lg object-cover flex aos-init aos-animate" src="/CodeCurso.JPG" alt="Imagem de capa do site Code Tower" data-aos="fade-up" title="Grupo Code Tower" width="750" height="500" />
            </div>
        </div>
    )
}
