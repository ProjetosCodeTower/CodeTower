...
export const Sobre = () => {
    return (
        <div className="container flex">
            ...
            <Image className="hidden h-72 w-full rounded-lg object-cover lg:flex aos-init aos-animate" src="/CodeCurso.JPG" alt="Imagem de capa do site Code Tower" data-aos="fade-up" title="Grupo Code Tower" width="750" height="500" />
        </div>
    )
}
