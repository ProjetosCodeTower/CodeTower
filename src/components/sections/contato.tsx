        ...
        <div className="container">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <form onSubmit={handleContact} className="flex flex-col justify-end items-end space-y-4 aos-init aos-animate" data-aos="fade-in">
                    ...
                    <Button type='submit' className="font-poppins py-2 shadow hover:opacity-75 bg-dark text-white hover:bg-primary rounded-lg px-6 uppercase lg:px-3" variant="default">Enviar</Button>
                </form>
            </div>
